...
typedef enum {
    DW_SPI_CLOCK_POLARITY_LOW   = 0,
    DW_SPI_CLOCK_POLARITY_HIGH  = 1
} DW_SPI_CLOCK_POLARITY;

typedef enum {
    DW_SPI_CLOCK_PHASE_MIDDLE   = 0,
    DW_SPI_CLOCK_PHASE_START    = 1
} DW_SPI_CLOCK_PHASE;
...
typedef enum {
    ...
    DW_SPI_DATASIZE_8   = 7,
    DW_SPI_DATASIZE_9   = 8,
    DW_SPI_DATASIZE_10  = 9,
    DW_SPI_DATASIZE_11  = 10,
    DW_SPI_DATASIZE_12  = 11,
    DW_SPI_DATASIZE_13  = 12,
    DW_SPI_DATASIZE_14  = 13,
    DW_SPI_DATASIZE_15  = 14,
    DW_SPI_DATASIZE_16  = 15
} DW_SPI_DATAWIDTH;
...
typedef struct {
    ...
    __IOM uint32_t SPIENR;      /* Offset: 0x008 (R/W)  SSI enable regiseter */
    __IOM uint32_t MWCR;      /* Offset: 0x00C (R/W)  Microwire control regiseter */
