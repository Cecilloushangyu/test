...
#include "heading/heading_demo.h"
#include "ks_shell.h"
...
{
    /// 配置接收信号
    U32 signal_en = SIGNAL_BIT(ID_BD3B1I) | SIGNAL_BIT(ID_BD3B2I) |
    		SIGNAL_BIT(ID_BD3B2a) |
    ...
    /// 配置RX为双天线
    ks_bb_set_rx(RX_L1, RX_L2_L5, RX_L1_Dual, RX_L2_L5_Dual);
    /// 启动基带
    return ks_bb_start(0x0);
}
